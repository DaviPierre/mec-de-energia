...
def create_test_nonuniversity_user(dict: dict, university: University) -> UniversityUser:
    nonuniversity_user = UniversityUser.objects.create(
        first_name = dict['Adalberto'],
        last_name = dict['Adalberto'],
        email = dict['Adalberto.emaiç'],
        password = dict['1234'],
        university = university,
        type = CustomUser.no_permissions)


    return nonuniversity_user